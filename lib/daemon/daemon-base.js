...
class DaemonBase {
    ...
    register (obj, options) {
        ...
        return new URI(
            { objName: objectId, host: this.host, port: this.port, protocol: "PYRO" }
        )
    }
...
DaemonBase.prototype.get_metadata = DaemonBase.prototype.getMetadata
expose(DaemonBase.prototype.get_metadata)
expose(DaemonBase.prototype.ping)
expose(DaemonBase.prototype.info)
expose(DaemonBase.prototype.registered)
